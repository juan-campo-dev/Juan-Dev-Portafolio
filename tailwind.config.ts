  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "radial-gradient-section": "radial-gradient(circle at center, #1a1a1a 0%, #0a0a0a 100%)",
        // "hero-pattern": "url('/images/hero-grid.svg')", // Eliminado porque ya no se usa
      },
    },
  },
