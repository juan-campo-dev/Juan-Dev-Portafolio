...
// Iconos pre-coloreados con los colores oficiales de cada tecnologia.
// Definirlos aqui evita repetir el "color" en cada uso y mantiene un look
// consistente entre la card del proyecto y el modal de detalles.
const TECH = {
  ...
  maps: <SiGooglemaps color="#4285F4" />,
...
export const PROJECTS: Project[] = [
  // ───────────────────────────── EMPRESARIALES ─────────────────────────────
  {
    ...
    techs: [TECH.php, TECH.js, TECH.mysql, TECH.docker, TECH.ia],
    githubUrl: undefined,
    githubPrivate: true,
    demoUrl: undefined,
    demoPrivate: true,
  ...
  },
  {
    ...
    techs: [TECH.js, TECH.php, TECH.mysql],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.react, TECH.laravel, TECH.mysql, TECH.maps, TECH.ia],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.php, TECH.js, TECH.mysql, TECH.python, TECH.docker],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.php, TECH.react, TECH.mysql, TECH.bootstrap],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.php, TECH.vue, TECH.mysql],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.react, TECH.laravel, TECH.mysql, TECH.maps],
    githubPrivate: true,
  ...
  },
  {
    ...
    techs: [TECH.python, TECH.flask, TECH.html, TECH.css],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.react, TECH.bootstrap, TECH.ia],
    githubPrivate: true,
    demoPrivate: true,
    demoSoon: false,
    category: "empresarial",
  ...
  },
  {
    ...
    techs: [TECH.html, TECH.css, TECH.python, TECH.ia],
  ...
  },
  {
    ...
    techs: [TECH.html, TECH.css, TECH.flask, TECH.python],
  ...
  // ───────────────────────────── ACADÉMICOS ─────────────────────────────
  {
    ...
    techs: [TECH.php, TECH.js, TECH.mysql, TECH.html],
