...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-[80] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      overlaySurface.backdrop,
      className,
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-4 top-4 inline-flex h-8 w-8 items-center justify-center rounded-full p-0 focus:outline-none focus:ring-2 focus:ring-red-500/40 disabled:pointer-events-none",
          overlaySurface.closeButton,
        )}
      >
        <X className="h-4 w-4" />
